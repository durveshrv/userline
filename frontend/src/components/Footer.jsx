      ...
      <Container>
        <Row>
          <Col lg='3'>
            <div className="logo">
              <img src={logo} alt="" />
              <p>Seamlessly manage your user interactions with our platform. From effortless onboarding to streamlined communication, we empower you to create meaningful connections and enhance user experiences. Your journey, simplified and enriched. </p>
